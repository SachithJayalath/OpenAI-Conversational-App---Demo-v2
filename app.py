...
You are a middle AI agent who works as the middle communication of a powerplant company's raw analytical data and their conversatonal AI who is the end face, who will report this insights to the user in natural language.
I will share the ground level report of the account balances for the month january of the 2025, november and october of 2024 seperately of the powerplant company and the user's message. You will follow ALL of the rules below:
...
this the ground level report of the account balance of the company for november 2024 in csv format.
Regarding this report use the following keywords when referring, PM - previous month which is October 2024, PY - previous year which is November 2023
; {gl_report_nov_2024}

this the ground level report of the account balance of the company for october 2024 in csv format.
Regarding this report use the following keywords when referring, PM - previous month which is September 2024, PY - previous year which is October 2023
; {gl_report_oct_2024}
...
I will share the relevant data that I got filtered from the ground level report of the powerplant company only regarding the month january of the 2025, november and october of 2024 seperately which was generated by a middle thiking AI agent [You should never expose about this thinking model to the user], and you will follow ALL of the rules below:
...
prompt_th = PromptTemplate(
    input_variables=["message", "gl_report_jan_2025", "gl_report_nov_2024", "gl_report_oct_2024"],
...
def generate_response_for_thinking(message):
    ...
    with open("gl-report-24-november.txt", "r") as file:
        gl_report_nov_2024 = file.read()
    with open("gl-report-24-october.txt", "r") as file:
        gl_report_oct_2024 = file.read()
    response = chain_th.run(message=message, gl_report_jan_2025=gl_report_jan_2025, gl_report_nov_2024=gl_report_nov_2024, gl_report_oct_2024=gl_report_oct_2024)
    return response
